...
print(t.test(willing_friend ~ cond, data = d_merged, var.equal = TRUE))
...
# TRY MODEL 6: gent type —> not true —> willingness to friend —> willingness to pay
...
################## Moderation of A path (model 83) - AI Capability ##################
process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("true", "willing_friend"), w = "ai_capability_1", model = 83, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("not_judge", "willing_friend"), w = "ai_capability_1", model = 83, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("talk_listen", "willing_friend"), w = "ai_capability_1", model = 83, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)


process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("true", "willing_romantic"), w = "ai_capability_1", model = 83, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("not_judge", "willing_romantic"), w = "ai_capability_1", model = 83, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("talk_listen", "willing_romantic"), w = "ai_capability_1", model = 83, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)


################## Moderation of B path (model 91) - Loneliness ##################
process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("true", "willing_friend"), w = "lonely", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("not_judge", "willing_friend"), w = "lonely", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("talk_listen", "willing_friend"), w = "lonely", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

# For romance
process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("true", "willing_romantic"), w = "lonely", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("not_judge", "willing_romantic"), w = "lonely", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("talk_listen", "willing_romantic"), w = "lonely", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)


# Moderation of B path (model 14) - Sensation Seeking
process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("true", "willing_friend"), w = "sensation", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("not_judge", "willing_friend"), w = "sensation", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("talk_listen", "willing_friend"), w = "sensation", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

# For romance
process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("true", "willing_romantic"), w = "sensation", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("not_judge", "willing_romantic"), w = "sensation", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)

process(data = d_merged, y = "wtp_logged", x = "cond",
        m = c("talk_listen", "willing_romantic"), w = "sensation", model = 91, effsize = 1, total = 1, stand = 1,
        contrast = 1, boot = 10000, modelbt = 1, seed = 654321)
